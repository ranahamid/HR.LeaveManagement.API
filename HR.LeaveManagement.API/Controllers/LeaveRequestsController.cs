...
namespace HR.LeaveManagement.API.Controllers
{
    ...
    public class LeaveRequestsController : ControllerBase
    {
        ...
        public async Task<ActionResult> ChangeApproval(int id, [FromBody] ChangeLeaveRequestApprovalDto leaveAllocation)
        {
            var command = new UpdateLeaveRequestCommand
            {
                Id = id,
                ChangeLeaveRequestApprovalDto = leaveAllocation,
            };
            var response = _mediator.Send(command);
            return NoContent();
        } 
